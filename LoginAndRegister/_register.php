<?php
include 'ConectionDB/ConectionToDB.php';
$conect=new DB();
...
$statement=$conect->connect()->prepare('SELECT * FROM dbo."Estudiantes" WHERE matricula=:StudentsId limit 1');
$statement->execute(array(':StudentsId'=> $StudentsId));
$resultado=$statement->fetch();

if ($resultado != false) {
    $error.='<p>Esta matricula ya esta registrada</p>';
...
$statement=$conect->connect()->prepare($sql);
...
header('Location:L_R_views/userRegistered.html');
}
...
require 'L_R_views/register.view.php';
